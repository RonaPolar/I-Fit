...
import 'package:ifit/screens/clients_main_screens/profile_screens/settings/success_email.dart';
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        const Gap(15),
                        const TextfieldContainer(hitText: 'Current Email',
                          icon: FluentSystemIcons.ic_fluent_mail_regular,
                          obscureText: false,
                        ),
                        const Gap(15),
                        const TextfieldContainer(hitText: 'New Email',
                          icon: FluentSystemIcons.ic_fluent_mail_regular,
                          obscureText: false,
                        ),
                        const Gap(5),
                    ...
                    onYesPressed: () {
                      Navigator.pushReplacement(context,MaterialPageRoute(
                        builder: (context) => VerificationCodeScreen(onConfirmPressed: () {
                          Navigator.pushReplacement(context,MaterialPageRoute(
                            builder: (context) => const SuccessEmail()),);
                        },)),);
                    },
                  );});
            }),
